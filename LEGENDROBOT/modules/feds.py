...
import LEGENDROBOT.modules.sql.feds_sql as sql
...
from LEGENDROBOT.modules.helper_funcs.alternate import send_message
    ...
    if args:
        if args[0] == "json":
            ...
            with BytesIO(str.encode(backups)) as output:
                output.name = "LEGEND_fbanned_users.json"
                update.effective_message.reply_document(
                    document=output,
                    filename="LEGEND_fbanned_users.json",
            ...
            for users in getfban:
                ...
                backups += "\n"
            with BytesIO(str.encode(backups)) as output:
                output.name = "LEGEND_fbanned_users.csv"
                update.effective_message.reply_document(
                    document=output,
                    filename="LEGEND_fbanned_users.csv",
