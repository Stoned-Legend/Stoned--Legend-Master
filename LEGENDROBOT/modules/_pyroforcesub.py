...
from LEGENDROBOT import DRAGONS as SUDO_USERS
from LEGENDROBOT import pbot
from LEGENDROBOT.modules.sql_extended import forceSubscribe_sql as sql
...
❍ LEGEND can mute members who are not subscribed your channel until they subscribe
