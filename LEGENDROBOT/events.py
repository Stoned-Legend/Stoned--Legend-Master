...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import LEGENDROBOT.events

        path = Path(f"LEGENDROBOT/modules/{shortname}.py")
        name = "LEGENDROBOT.modules.{}".format(shortname)
        ...
        mod.LEGENDROBOT = LEGENDROBOT
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["LEGENDROBOT.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "LEGENDROBOT/modules/*.py"
