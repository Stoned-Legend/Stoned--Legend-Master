...
PM_START_TEXT = """
Hello My name is [Aditya](https://telegra.ph/file/22d0976cc9c7627d48319.jpg)
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD LEGEND TO YOUR GROUP ➕️", url="t.me/Mr_hacker_Aditya_bot?startgroup=true"),
    ],
    [
...
def LEGEND_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "LEGEND_":
        query.message.edit_text(
            text=""" ℹ️ I'm *Aditya*, a powerful group management bot built to help you manage your group easily.
                 ...
                 Here is the [💾Repository](https://github.com/Aditya-chandan-os/LEGENDROBOT).
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *LEGEND*
                 \nHere is the [Source Code](https://github.com/Aditya-chandan-os/LEGENDROBOT) .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
