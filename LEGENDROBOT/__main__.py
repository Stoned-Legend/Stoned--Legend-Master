...
PM_START_TEXT = """
Hellow 🙋‍♀ My name is [LEGEND](https://telegra.ph/file/3b2c3f069f49b8a4dc3cd.jpg)
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD LEGEND TO YOUR GROUP ➕️", url="t.me/Legend_Mr_Robot?startgroup=true"),
    ],
    [
    ...
    if query.data == "LEGEND_":
        query.message.edit_text(
            text=""" ℹ️ I'm *LEGEND*, a powerful group management bot built to help you manage your group easily.
                 ...
                 If you have any question about LEGEND, let us know at @Legend_Mr_Hacker.""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
