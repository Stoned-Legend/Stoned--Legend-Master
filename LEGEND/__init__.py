# This file is part of LEGEND (Telegram Bot)
...
from LEGEND.config import get_bool_key, get_int_key, get_list_key, get_str_key
from LEGEND.utils.logger import log
from LEGEND.versions import LEGEND_VERSION

log.info("----------------------")
log.info("|      Suize      |")
log.info("----------------------")
log.info("Version: " + LEGEND_VERSION)

if get_bool_key("DEBUG_MODE") is True:
    LEGEND_VERSION += "-debug"
