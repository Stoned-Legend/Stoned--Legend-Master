...
LEGEND v2 -Base Aiogram
(C) 2020-2021 by @LEGEND-OS
OWNER is @Legend_Mr_Hacker.
...
=++---------------------------------------------++=
LEGEND. Deployed Successfully

 ***************************
 * 🆂 🆄 🅸 🆉 🅴 *
 ******************* v2.0 ** 

Thanks for deploying LEGEND
(C) 2020-2021 by @LEGEND-OS
Support Chat is @Legend_Mr_Hacker.
=++---------------------------------------------++=
